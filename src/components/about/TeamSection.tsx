      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {TEAM_MEMBERS.map((member, index) => {
          ...
          return (
            <div
              key={member.id}
              className={`group glass-card p-8 md:p-10 rounded-3xl relative overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:border-secondary/50 hover:shadow-[0_10px_35px_rgba(59,130,246,0.15)] flex flex-col justify-between ${
