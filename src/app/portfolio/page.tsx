  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
        ...
        {/* Project 1: AI Business Partner (Flagship Product) */}
        <div className="glass-card rounded-3xl overflow-hidden group service-card border border-purple-500/30 hover:border-purple-500/60 transition-all duration-300 shadow-[0_0_25px_rgba(139,92,246,0.15)]">
          <div className="h-64 bg-slate-900 relative overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute top-3 left-3 z-10">
              <span className="px-3 py-1 rounded-full bg-purple-500/20 backdrop-blur-md border border-purple-400/40 text-purple-300 text-[10px] font-bold tracking-wider uppercase flex items-center gap-1 shadow-lg">
                <Star className="w-3 h-3 text-amber-300 fill-amber-300" /> ⭐ NNP Flagship Product | Built In-House
              </span>
            </div>
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
              <span className="px-4 py-1.5 rounded-full bg-purple-600/80 backdrop-blur-md text-white text-xs font-bold tracking-widest uppercase">
                View Case Study
              </span>
            </div>
          </div>
          <div className="p-8">
            ...
            <h3 className="text-2xl font-bold mb-3 text-white">AI Business Partner</h3>
            ...
            <Link href="/portfolio/ai-business-partner" className="text-purple-400 font-medium flex items-center gap-2 text-sm group-hover:underline">
